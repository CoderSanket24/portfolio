const Footer = () => {
  return (
    <footer className="relative border-t border-slate-800/50 bg-[#0B0F19]/80 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Backend Engineer & AI/Data Science Specialist building scalable systems and intelligent applications.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="p-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-md transition-all hover:-translate-y-0.5 text-slate-400 hover:text-cyan-400"
              >
        ...
        <div className="pt-8 border-t border-slate-800/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-500 font-mono">
              © {new Date().getFullYear()} Sanket Botre. All systems operational.
            </p>
